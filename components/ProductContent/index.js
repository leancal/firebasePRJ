...
export default function ProductContent({ prod, productData }) {
  console.log('ProductContent: productData', productData);
  console.log('ProductContent: prod', prod);
        ...
        {mode == 0 && (
          <div className={`default${prod.altBackground ? ' bg-alt' : ''}`} linea={prod.line}>
            ...
            <div className='cover-wrapper'>
              <Image className='cover' src={prod.imgs[0]} fill alt='product-cover' priority />
            </div>
          </div>
        )}
        {/* {mode == 1 && (
