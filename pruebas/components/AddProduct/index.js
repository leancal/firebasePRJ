      ...
      <div className="app-container">
        <div className="sidebar">
          ...
          <ul className="sidebar-list">
            <li className="sidebar-list-item">
              <a href="#" onClick={handleCollectionFormClick}> {/* Agrega un controlador de clic para mostrar el formulario */}
        ...
        <div className="app-content" >
          ...
          <div className="app-content-actions">
            ...
            {showProductDataForm && (
              <ProductDataForm product={product} handleChange={handleChange} />
            )}
